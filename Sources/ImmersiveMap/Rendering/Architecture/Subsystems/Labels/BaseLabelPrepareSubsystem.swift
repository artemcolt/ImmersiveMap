...
final class BaseLabelPrepareSubsystem: RenderSubsystem {
    ...
    init(baseLabelCache: BaseLabelCache,
         ...
         library: MTLLibrary,
         settings: MapSettings.LabelSettings = MapSettings.default.labels) {
    ...
    convenience init(baseLabelCache: BaseLabelCache,
                     ...
                     fadeInSeconds: TimeInterval = MapSettings.default.labels.base.fadeInSeconds,
                     fadeOutSeconds: TimeInterval = MapSettings.default.labels.base.fadeOutSeconds,
                     roadGridCellSizePx: Float = MapSettings.default.labels.road.gridCellSizePx,
                     orientationScoreEpsilon: Float = MapSettings.default.labels.road.orientationScoreEpsilon,
                     maxGlyphTurnRadians: Float = MapSettings.default.labels.road.maxGlyphTurnRadians) {
        var settings = MapSettings.default.labels
