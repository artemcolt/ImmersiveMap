...
struct FrameContext {
    ...
    let mapCameraState: MapCameraState
    ...
    var mapPresentationState: MapPresentationState {
    ...
    var visibilityMode: VisibilityMode {
        resolvedPresentation.visibilityMode
    }
    ...
    init(frameIndex: UInt64,
         ...
         mapCameraState: MapCameraState = .default,
        ...
        let fallbackResolvedPresentation = resolvedPresentation ?? ViewModeCalculator.resolve(cameraState: mapCameraState,
                                                                                              ...
                                                                                              visibilityPolicy: .followPresentation)
