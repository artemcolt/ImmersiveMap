...
final class DebugOverlayRenderer {
    private var settings: MapSettings.DebugSettings
    ...
    init(metalDevice: MTLDevice,
         settings: MapSettings.DebugSettings) {
    ...
    convenience init(metalDevice: MTLDevice) {
        self.init(metalDevice: metalDevice, settings: MapSettings.default.debug)
    }

    func apply(settings: MapSettings.DebugSettings) {
        self.settings = settings
    }
    ...
    private func makeTileOriginData(for placeTile: PlaceTile,
        ...
        let originAndSize = MapProjection.flatTileOriginAndSize(x: placeTile.placeIn.x,
