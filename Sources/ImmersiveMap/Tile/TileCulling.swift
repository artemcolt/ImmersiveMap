...
class TileCulling {
    ...
    func resolveVisibleContent(cameraState: MapCameraState,
    ...
    private func makeCenter(centerWorldMercator: SIMD2<Double>,
        ...
        return Center(tileX: MapProjection.wrapNormalizedWorldX(centerWorldMercator.x) * tilesCount,
                      tileY: MapProjection.clampNormalizedWorldY(centerWorldMercator.y) * tilesCount)
    }
