...
class DefaultMapStyle: MapStyle {
    static let preparedTileStyleRevisionValue: UInt32 = MapSettings.default.style.preparedTileStyleRevision
    ...
    private let mapBaseColors: MapBaseColors
    private let styleSettings: MapSettings.StyleSettings
    private let poiSpriteResolver = PoiSpriteResolver()

    init(settings: MapSettings.StyleSettings = MapSettings.default.style) {
        self.styleSettings = settings
        self.mapBaseColors = MapBaseColors(settings: settings.baseColors)
