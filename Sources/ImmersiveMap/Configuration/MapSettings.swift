...
public struct MapSettings: Equatable {
    ...
    public struct CameraSettings: Equatable {
        ...
        public init(maximumPitch: Float,
                    ...
                    globePitchUnlockZoom: Double = 4.0,
    ...
    public struct TileSettings: Equatable {
        ...
        public struct NetworkSettings: Equatable {
            ...
            public init(maxConcurrentFetches: Int,
                        ...
                        tileBaseURL: URL = URL(string: "https://tucik.moscow/api/v1/map/tiles")!,
    ...
    public static func makeApplicationPlan(from oldValue: MapSettings,
                                           to newValue: MapSettings) -> ApplicationPlan {
    ...
    public static let `default` = MapSettings(
        ...
        scene: SceneSettings(mapClearColor: SIMD4<Double>(1.0, 1.0, 1.0, 1.0),
                             ...
                             starfield: StarfieldSettings(starCount: 3400,
                                                          ...
                                                          far: 6000.0,
                                                          radiusScale: 10.5)),
        style: StyleSettings(preparedTileStyleRevision: 81,
