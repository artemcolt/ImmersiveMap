...
enum GlobeVisibilityModel {
    ...
    static func makeInputs(globe: Globe,
        ...
        let panLatitude = Float(globe.panY) * Float(MapProjection.maxMercatorLatitude)
    ...
    private static func makeCoordinateBounds(for tile: Tile) -> TileCoordinateBounds {
        ...
        return TileCoordinateBounds(tile: tile,
                                    northLatitude: Float(MapProjection.latitude(fromNormalizedWorldY: Double(northWorldY))),
                                    southLatitude: Float(MapProjection.latitude(fromNormalizedWorldY: Double(southWorldY))),
                                    westLongitude: Float(MapProjection.longitude(fromNormalizedWorldX: Double(westWorldX))),
                                    eastLongitude: Float(MapProjection.longitude(fromNormalizedWorldX: Double(eastWorldX))))
    }
