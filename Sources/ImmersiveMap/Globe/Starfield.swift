...
//    to avoid affecting map depth precision. Tuned via MapSettings.scene.starfield.
//  - Space: background clear color configured in MapSettings.scene.space.
...
final class Starfield {
    ...
    private let config: MapSettings.StarfieldSettings
    ...
    init(metalDevice: MTLDevice,
         ...
         config: MapSettings.StarfieldSettings) {
    ...
    func draw(renderEncoder: MTLRenderCommandEncoder,
        ...
        renderEncoder.setFragmentBytes(&globeData,
                                       length: MemoryLayout<Globe>.stride,
                                       index: 2)
