...
final class AvatarsRenderer {
    private let config: MapSettings.AvatarSettings
    ...
    init(metalDevice: MTLDevice,
         layer: CAMetalLayer,
         library: MTLLibrary,
         config: MapSettings.AvatarSettings) {
        self.config = config
    ...
    func update(controller: AvatarsController, time: TimeInterval) {
